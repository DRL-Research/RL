...
ALTERNATE_MASTER_AND_AGENT_TRAINING = True  # options: True/False
...
LEARNING_RATE = 0.003
LOSS_FUNCTION = "mse"
TIME_BETWEEN_STEPS = 2.0
COPY_CAR1_NETWORK_TO_CAR2 = True  # options: True/False
...
LOG_WEIGHTS_ARE_IDENTICAL = False  # options: True/False
