...
class Experiment:
    ...
    ALGORITHM: str = "MAPS"  # MAPS | maddpg | vn_maddpg
    ...
    MADDPG_CRITIC_LR: float = 5e-4
    MADDPG_GAMMA: float = 0.99
    MADDPG_TAU: float = 0.01
    MADDPG_BATCH_SIZE: int = 256
    MADDPG_BUFFER_SIZE: int = 100000
    MADDPG_WARMUP_STEPS: int = 1000
    MADDPG_UPDATES_PER_STEP: int = 1
    MADDPG_TRAIN_EVERY: int = 1
    MADDPG_TARGET_UPDATE_INTERVAL: int = 90
    MADDPG_HIDDEN_DIM: int = 128
    MADDPG_INITIAL_NOISE: float = 0.25
    MADDPG_FINAL_NOISE: float = 0.0
    MADDPG_PRIORITY_ALPHA: float = 0.6
    MADDPG_PRIORITY_BETA_START: float = 0.4
    MADDPG_GUMBEL_TAU: float = 1.0
    MADDPG_MAX_GRAD_NORM: float = 1.0
