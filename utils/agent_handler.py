...
class Agent(gym.Env):
    ...
    def __init__(self, experiment, airsim_manager):
        ...
        # self.observation_space = spaces.Box(low=-np.inf, high=np.inf, shape=(2,), dtype=np.float32)  # TODO: delete this line?
    ...
    # This function override base function in "GYM" environment. do not touch!
    def close_env(self):  # TODO: this function should be in airsim_manager
