...
def inference_loop(p_agent_loss, p_master_loss, p_episode_counter, experiment, env, agent_model, master_model, agent):
    ...
    if experiment.ONLY_INFERENCE: # inference mode logic only
...
def run_experiment(experiment_config):
    if experiment_config.ONLY_INFERENCE:
        ...
        master_model.load("EXP5_Inference_Models/trained_model_master.zip")
        ...
        agent1_model = Model.load("EXP5_Inference_Models/agent_trained_model.zip", env,
                                  experiment_config).model
        agent2_model = Model.load("EXP5_Inference_Models/agent_trained_model.zip", env,
                                  experiment_config).model
        # Configure loggers
