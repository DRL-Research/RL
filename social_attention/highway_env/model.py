"""
Ego-Attention DQN — faithful reproduction of:
  "Social Attention for Autonomous Decision-Making in Dense Traffic"
  Leurent & Mercat, 2019.  https://arxiv.org/abs/1911.12250

Verified against rl-agents @ master:
  rl_agents/agents/common/models.py  (EgoAttention, EgoAttentionNetwork, MultiLayerPerceptron)
  scripts/configs/HighwayEnv/agents/DQNAgent/ego_attention.json  (+ ddqn.json, dqn.json)
  scripts/configs/HighwayEnv/env_obs_attention.json              (highway-v0 observation)

Architecture (HighwayEnv ego_attention.json — same as the 2h variant, heads=2):
...
EMBED_DIM  = 64
N_HEADS    = 2
N_VEHICLES = 15   # 1 ego + 14 neighbors (env_obs_attention.json: vehicles_count 15)
N_ACTIONS  = 5    # highway-v0 DiscreteMetaAction: LANE_LEFT, IDLE, LANE_RIGHT, FASTER, SLOWER
