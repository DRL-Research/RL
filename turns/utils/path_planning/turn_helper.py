...
def create_bezier_curve(client, initial_yaw, vehicle_pose, direction, moving_car_name):
    ...
    global_curve_points = path_following.generate_curve_points(start_point_global_np, control_point_global,
...
def filter_tracked_points_and_generate_spline(tracked_points,moving_car_name):
    ...
    if CREATE_SUB_PLOTS:
        plots_utils_turns.plot_the_spline(spline_obj.xi, -1 * spline_obj.yi, moving_car_name)
    return spline_obj
